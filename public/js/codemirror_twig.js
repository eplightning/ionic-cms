...
CodeMirror.defineMode("twig", function(config, parserConfig) {
	  return CodeMirror.overlayMode(CodeMirror.getMode(config, parserConfig.backdrop || "text/html"), CodeMirror.getMode(config, parserConfig.backdrop || "text/jinja2"));
});

CodeMirror.defineMIME("text/twig", "twig");