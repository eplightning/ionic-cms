var IonicAdmin = {
	...
	addCheckbox: function(id) {
		if (this.selectedCheckboxes.indexOf(id) == -1)
		{
	...
	isCheckboxAdded: function(id) {
		return (this.selectedCheckboxes.indexOf(id) != -1);
	},
	
	removeCheckbox: function(id) {
		var index = this.selectedCheckboxes.indexOf(id);
	...
	collectCheckboxIds: function() {
		return this.selectedCheckboxes.join(',');
	},
	
	addOption: function(content) {
		this.options++;
		
		content = content.replace(/optid/g, this.options);
		
		$('#elements').append(content);
	},
	
	deleteOption: function() {
		$('#opt-'+this.options).remove();
		
		this.options--;
	},
	
	setOptionsCount: function(count) {
		this.options = count;
	}
};
...
$(document).ready(function() {
	...
	{
		$('a.lightbox').lightBox({
			imageLoading: IONIC_BASE_URL+'public/img/lightbox-ico-loading.gif',
			imageBtnClose: IONIC_BASE_URL+'public/img/lightbox-btn-close.gif',
			imageBtnPrev: IONIC_BASE_URL+'public/img/lightbox-btn-prev.gif',
			imageBtnNext: IONIC_BASE_URL+'public/img/lightbox-btn-next.gif',
			imageBlank: IONIC_BASE_URL+'public/img/lightbox-blank.gif'
		});
	}
});
