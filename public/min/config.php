...
// dirname(__FILE__) = /public/min
// substr(dirname(__FILE__), 0, strlen(dirname(__FILE__)) - 10) = /

$min_cachePath = substr(dirname(__FILE__), 0, strlen(dirname(__FILE__)) - 10).'private'.DIRECTORY_SEPARATOR.'storage'.DIRECTORY_SEPARATOR.'min';
