...
class Payload {
	 ...
	 * @param string $url
	 */
	public function location($name, $url = NULL)
	{
		$this->session['location_name'] = $name;
		$this->session['location_url'] = ($url ?: \URI::current());
	}
	 ...
	 * @param bool $anon
	 */
	public function userdata($id = NULL, $anon = FALSE)
	{
		if (!$id)
		{
