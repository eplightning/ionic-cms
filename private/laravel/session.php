...
class Session {
	 ...
	 * @param string $url
	 */
	public static function location($name, $url = NULL)
	{
		static::instance()->location($name, $url);
	}
	 ...
	 * @param bool $anon
	 */
	public static function userdata($id = NULL, $anon = FALSE)
	{
		static::instance()->userdata($id, $anon);
	}
