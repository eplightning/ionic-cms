...
class Cookie {
	...
	public static function put($name, $value, $expiration = 0, $path = '/', $domain = null, $secure = false)
	{
		...
		// Get default path and domain from configuration
		$path = Config::get('application.cookie_path');
		$domain = Config::get('application.cookie_domain');

		// If domain was empty make sure it's null
