...
class Table {
	 ...
	 * @return Fluent
	 */
	public function integer($name, $increment = false, $bytes = 4)
	{
		return $this->column(__FUNCTION__, compact('name', 'increment', 'bytes'));
	}
	 ...
	 * @return Fluent
	 */
	public function text($name, $bytes = 2)
	{
		return $this->column(__FUNCTION__, compact('name', 'bytes'));
	}
	 ...
	 * @return Fluent
	 */
	public function blob($name, $bytes = 2)
	{
		return $this->column(__FUNCTION__, compact('name', 'bytes'));
	}
